...
- [x] Free cloud backend deployment & auto-seeding: Containerized backend with `Dockerfile`, created `render.yaml` blueprint, and added `seed_if_empty()` auto-seeding to `app/main.py` lifespan for zero-touch cloud deployments (`2026-09-06`)
